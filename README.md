...
| :--- | :--- | :--- | :--- | :--- |  
| [Ratify](https://github.com/EvSivtsova/ratify-app) | A mobile app for owners of exotic pets that offer fast access to information on how to take of their pets and view maps with suitable vets and shops. Easily scalable. | 2 days - planning and exploring new technology (React Native, APIs) <br> 5 days - coding <br> 2 days - finalising and presenting | [Arsenii](https://github.com/Agabov123) <br> [Delphine](https://github.com/delphiine) <br> [Joe](https://github.com/Joseph-ER) <br> myself | JavaScript, Node, Express, MongoDB, React Native, Jest | 
| [MakersBNB](https://github.com/EvSivtsova/makersbnb) | A web app that connects property owners and potential renters, similar to AirBnb. | 1 days - planning<br> 3.5 days - coding<br> 0.5 days - presenting | [Joe](https://github.com/Joseph-ER)<br>[Karolina](https://github.com/karolina-codes)<br>[Paris](https://github.com/ParisMonson)<br> myself | Ruby, Sinatra, PostgreSQL, HTML, CSS | 
| [Acebook](https://github.com/EvSivtsova/acebook-the-pyjamas) | A social media web app that allows adding friends, posting comments, and likes.<br> [Deployed with Heroku and MongoDB Atlas](https://acebook-ev-pyjamas.herokuapp.com) | 1.5 days - planning<br>3 days - coding<br>0.5 day - presenting<br> | [Ahmed](https://github.com/meddydev)<br>[Irina](https://github.com/IrinaVi)<br>[Paris](https://github.com/ParisMonson)<br>[Sara](https://github.com/Saraesabbagh)<br>[Shaun](https://github.com/shaunywho)<br>myself | Javascript, Node, Express, Handlebars, MongoDB, Jest |
